...
| RF-89 | M | El pie de contenido de las páginas de zona y municipio se separa de la aplicación con una banda en `--petrol`, presenta sus filas con el componente `Lista` por debajo de 700 px, se pliega mostrando tres filas con un control para desplegar el resto, y enlaza a otros municipios con pastillas que incluyen su precio mínimo. En móvil se llega desde la última fila de la hoja en posición completa. Ningún contenido queda inalcanzable. Ver `docs/05-diseno.md`, sección "Pie de contenido". |
