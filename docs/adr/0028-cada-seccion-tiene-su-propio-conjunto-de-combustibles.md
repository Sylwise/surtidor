...
**Editoriales y comparaciones: cinco.** Entra el gasóleo B, queda fuera el
GLP. Un coche de GLP consume entre un 20 y un 30 % más volumen, así que su
precio por litro no es comparable con el resto y saldría siempre como el más
barato sin serlo.
...
- **Los seis en todas partes.** Imposible en Evolución: no hay datos. Y en
  las editoriales el GLP falsearía los titulares.
