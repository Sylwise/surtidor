...
const historico = { version: 1, provinciaId: '01', fechas, estaciones: [['1', Array(90).fill(1), precios, Array(90).fill(null), Array(90).fill(null), Array(90).fill(null)]], provincia: agregado, municipios: {} } as HistoricoProvincia;
