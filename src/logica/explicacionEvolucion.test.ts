...
const historico = { version: 1, provinciaId: '01', fechas, estaciones: series.map((serie, indice) => [String(indice + 1), '1', Array(90).fill(1), serie, Array(90).fill(null), Array(90).fill(null), Array(90).fill(null)]), provincia: agregado(series), municipios: {} } as HistoricoProvincia;
